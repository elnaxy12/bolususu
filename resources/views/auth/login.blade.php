...
<head>
    ...
    <title>Login — Bolu Susu Lembang</title>
    <link rel="icon" href="{{ asset('images/LOGO-BSL-.png') }}" type="image/png">
    <link rel="preconnect" href="https://fonts.googleapis.com" />
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin />
    <link href="https://fonts.googleapis.com/css2?family=Playfair+Display:ital,wght@0,700;0,900;1,700&family=DM+Sans:wght@300;400;500;600&family=Cinzel:wght@600&display=swap" rel="stylesheet" />
    <style>
        :root {
            --navy: #0d1f3c;
            --teal: #1a9e8f;
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* Radial glow — sama persis seperti hero */
        body::before {
            content: '';
            position: fixed;
            inset: 0;
        ...
        /* Decorative dots */
        .dot { position: fixed; border-radius: 50%; pointer-events: none; z-index: 0; }
        .dot-gold  { width:10px; height:10px; background:var(--gold);       opacity:.5;  top:18%;    right:18%; }
        .dot-teal  { width:7px;  height:7px;  background:var(--teal-light); opacity:.5;  bottom:22%; left:14%;  }
        .dot-gold2 { width:6px;  height:6px;  background:var(--gold);       opacity:.35; top:60%;    right:12%; }
        ...
        .logo-ring img { width:68px; height:68px; object-fit:contain; }
        ...
        .section-divider span { color: var(--gold); font-size: 11px; opacity: .8; }

        /* Alerts */
        .alert { border-radius:10px; padding:10px 14px; font-size:13px; font-weight:500; margin-bottom:14px; }
        .alert-success { background:rgba(26,158,143,0.15); border:1px solid rgba(26,158,143,0.4); color:#7de0cc; }
        .alert-error   { background:rgba(220,80,80,0.12);  border:1px solid rgba(220,80,80,0.35);  color:#f4a0a0; }
        ...
        .invalid-feedback { font-size:12px; color:#f4a0a0; margin-top:5px; }
        ...
        .remember-label { display:flex; align-items:center; gap:7px; color:rgba(255,255,255,0.45); cursor:pointer; font-size:13px; }
        input[type="checkbox"] { width:15px; height:15px; accent-color:var(--teal); cursor:pointer; }
        .forgot { color:var(--gold); font-size:13px; font-weight:500; text-decoration:none; transition:color .2s; }
        ...
        .btn-login:hover { box-shadow: 0 8px 32px rgba(26,158,143,0.35); }
        .btn-login:active { transform:scale(0.984); }
        ...
        .register-row a { color:var(--gold); font-weight:600; text-decoration:none; transition:color .2s; }
...
<body>
    ...
    <div class="card">
        ...
        <div class="logo-area">
            ...
            <p class="brand-tagline">Portal Manajemen</p>
        </div>
        ...
        <form method="POST" action="{{ route('login') }}" id="loginForm">
            ...
            <div class="form-group">
                ...
                <input
                    ...
                    value="{{ old('email') }}"
                    placeholder="email@bolususulembang.com"
            ...
            <div class="form-group">
                ...
                <div class="pass-wrap">
                    ...
                    />
                    <button type="button" class="pass-toggle" onclick="togglePass()" aria-label="Lihat password">
