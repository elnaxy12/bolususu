...
<head>
    ...
    <title>Bolu Susu Lembang – Original Sejak 1990</title>
...
<body>
                ...
                <div class="flex justify-center anim-scale delay-2 relative">
                    <div
                        ...
                        <div class="text-center px-8">
                            ...
                            <p class="cinzel text-white text-xl font-bold tracking-wider">BOLU SUSU</p>
                            <p class="text-teal-300 text-sm tracking-widest mt-1">LEMBANG</p>
    ...
    <!-- ============ FOOTER ============ -->
    <footer class="py-8 text-center border-t border-white/10" style="background:#060f1e">
        <div class="max-w-4xl mx-auto px-6">
            <p class="cinzel text-white font-bold tracking-widest text-lg">BOLU SUSU LEMBANG</p>
            <p class="text-gray-500 text-sm mt-2">Kelezatan Asli dari Dataran Tinggi Lembang</p>
            <div class="gold-line mt-6 max-w-xs mx-auto mb-6"></div>
            <p class="text-gray-600 text-xs">© 2025 Bolu Susu Lembang. Semua hak dilindungi.</p>
        </div>
    </footer>
    ...
    <script>
        // ---- PRODUCTS DATA ----
        const products = [
            { id: 1, name: 'Original', desc: 'Klasik & autentik, aroma susu segar yang khas dari Lembang.', price: 55000, emoji: '🍞', badge: 'Best Seller', tag: 'Original' },
            { id: 2, name: 'Pandan Susu', desc: 'Perpaduan harum pandan alami dengan kelembutan susu segar.', price: 60000, emoji: '🌿', badge: 'Favorit', tag: 'Pandan' },
            { id: 3, name: 'Coklat Susu', desc: 'Lelehan coklat premium berpadu dengan tekstur bolu yang lembut.', price: 65000, emoji: '🍫', badge: 'New', tag: 'Coklat' },
            { id: 4, name: 'Keju Susu', desc: 'Taburan keju mozzarella melimpah di atas bolu susu original.', price: 70000, emoji: '🧀', badge: null, tag: 'Keju' },
            { id: 5, name: 'Grapes', desc: 'Saus anggur asli dengan sensasi manis-asam yang menyegarkan.', price: 68000, emoji: '🍇', badge: null, tag: 'Grapes' },
            { id: 6, name: 'Hampers Box', desc: 'Paket 4 loyang pilihan dalam kotak hampers eksklusif siap kirim.', price: 240000, emoji: '🎁', badge: 'Paket Hemat', tag: 'Hampers' },
        ];
      ...
      <div class="product-card reveal" style="animation-delay:${i * 0.1}s">
        ...
        <div class="h-48 flex items-center justify-center text-7xl"
          style="background: linear-gradient(135deg, #e8f4f8, #d1ecec)">
          ${p.emoji}
        </div>
        <div class="p-5">
          ...
          <div class="flex items-center justify-between mt-5">
            <div>
              <p class="font-bold text-xl" style="color:var(--navy)">${formatRp(p.price)}</p>
    ...
    `).join('');
        ...
        function updateCartUI() {
            ...
            const totalPrice = keys.reduce((a, k) => a + cart[k].qty * cart[k].price, 0);
            ...
            if (keys.length === 0) {
                container.innerHTML = '<p id="cart-empty" class="text-gray-400 text-center py-12">Keranjang masih kosong 🛒</p>';
                return;
            }
      ...
      `;
        ...
        function checkout() {
            ...
            const msg = encodeURIComponent(`Halo Bolu Susu Lembang! Saya ingin memesan:\n${items}\nTotal: ${formatRp(total)}\n\nMohon konfirmasi pesanan saya. Terima kasih!`);
        ...
        function copyCode() {
            navigator.clipboard.writeText('LEMBANG3').then(() => showToast('Kode promo disalin!'));
        }
